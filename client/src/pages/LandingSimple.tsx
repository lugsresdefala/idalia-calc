    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-white">
      ...
      <div className="pt-24 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          {/* Sistema de Acesso */}
          <section className="py-12 border-b border-gray-200">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-xl text-center border border-gray-200">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                💎 Planos de Acesso Flexíveis
              </h2>
            <div className="grid md:grid-cols-2 gap-6 text-left max-w-2xl mx-auto">
                <div className="p-6 rounded-lg bg-white border-2 border-yellow-400 shadow-md">
                ...
                <div className="p-6 rounded-lg bg-white border-2 border-cyan-500 shadow-md">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">
                    🎫 Tokens Avulsos
                  </h3>
                  <p className="text-gray-600 mb-2">
